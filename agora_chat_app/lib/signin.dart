...
class ChatConfig {
  ...
  static const String userId = "007eJxTYGiZp/NOlkF+9rlC1YvLljz9Z5OxujCooGHGKsuys7N+vjitwGBkaZGaZGppZmJumWZiZpFimZpimWxsbmFqmGhhkGJgfFBdLK0hkJFBccUrFkYGVgZGIATxVRiMU8wMUg1NDXTTzIySdA0NU1N1E02MzHVTDFPSDFONjNPSzI0A8+ookA==";
  static const String agoraToken = '006298eb596479f468d9ed9c37851a80d03IACOQzfgoKpEZF/Uwvi9z5p3bb7lZAtMEEYsFIvIZ7j4VwAAAABVhVGMIgA5jtrG73gXZgQAAQB/NRZmAgB/NRZmAwB/NRZmBAB/NRZm';
}

void main() async {
  final appId = '298eb596479f468d9ed9c37851a80d03';
  final appCertificate = '9dbc12fae7d54956b278100f3d7312b9';
  final channelName = 'channel1';
  final uid = 'user1';
...
class CustomMessagesPage extends StatelessWidget {
  final ChatConversation conversation;

  const CustomMessagesPage(this.conversation);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Custom Messages Page'),
      ),
      body: Center(
        child: Text('Custom Messages Page Content'),
      ),
    );
  }
}
class ConversationsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Conversations Page'),
      ),
      body: Center(
        child: Text('Conversations Page Content'),
      ),
    );
  }
}
class MessagesPage extends StatelessWidget {
  ...
  const MessagesPage(this.conversation);
